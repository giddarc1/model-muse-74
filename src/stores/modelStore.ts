...
export function createDemoModel(): Model {
  ...
  return {
    ...
    operations: [
      ...
      { id: uid(), product_id: prodIds.HUB1, op_name: 'FNTURN', op_number: 50, equip_id: equipIds.VT_LATHE, pct_assigned: 100, equip_setup_lot: 45, equip_run_piece: 12, labor_setup_lot: 45, labor_run_piece: 12, ...defaultOpTimes },
      { id: uid(), product_id: prodIds.HUB1, op_name: 'INSPECT', op_number: 60, equip_id: equipIds.INSPECT, pct_assigned: 100, equip_setup_lot: 15, equip_run_piece: 4, labor_setup_lot: 15, labor_run_piece: 4, ...defaultOpTimes },
      ...
      { id: uid(), product_id: prodIds.HUB2, op_name: 'FNTURN', op_number: 50, equip_id: equipIds.VT_LATHE, pct_assigned: 100, equip_setup_lot: 45, equip_run_piece: 12, labor_setup_lot: 45, labor_run_piece: 12, ...defaultOpTimes },
      { id: uid(), product_id: prodIds.HUB2, op_name: 'INSPECT', op_number: 60, equip_id: equipIds.INSPECT, pct_assigned: 100, equip_setup_lot: 15, equip_run_piece: 4, labor_setup_lot: 15, labor_run_piece: 4, ...defaultOpTimes },
      ...
      { id: uid(), product_id: prodIds.HUB3, op_name: 'FNTURN', op_number: 50, equip_id: equipIds.VT_LATHE, pct_assigned: 100, equip_setup_lot: 45, equip_run_piece: 12, labor_setup_lot: 45, labor_run_piece: 12, ...defaultOpTimes },
      { id: uid(), product_id: prodIds.HUB3, op_name: 'INSPECT', op_number: 60, equip_id: equipIds.INSPECT, pct_assigned: 100, equip_setup_lot: 15, equip_run_piece: 4, labor_setup_lot: 15, labor_run_piece: 4, ...defaultOpTimes },
      ...
      { id: uid(), product_id: prodIds.HUB4, op_name: 'FNTURN', op_number: 50, equip_id: equipIds.VT_LATHE, pct_assigned: 100, equip_setup_lot: 45, equip_run_piece: 12, labor_setup_lot: 45, labor_run_piece: 12, ...defaultOpTimes },
      { id: uid(), product_id: prodIds.HUB4, op_name: 'INSPECT', op_number: 60, equip_id: equipIds.INSPECT, pct_assigned: 100, equip_setup_lot: 15, equip_run_piece: 4, labor_setup_lot: 15, labor_run_piece: 4, ...defaultOpTimes },
