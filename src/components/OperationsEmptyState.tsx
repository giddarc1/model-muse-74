  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-8 text-center">
      ...
      <div className="flex items-center gap-1.5 mb-6 flex-wrap justify-center">
        <Badge className="bg-[rgba(0,196,180,0.12)] text-primary border-primary/20 font-mono text-xs">DOCK</Badge>
        <ArrowRight className="h-3.5 w-3.5 text-muted-foreground" />
        <Badge variant="secondary" className="font-mono text-xs">+ operations</Badge>
        <ArrowRight className="h-3.5 w-3.5 text-muted-foreground" />
        <div className="flex flex-col items-center gap-1">
          <Badge className="bg-[rgba(0,196,180,0.12)] text-primary border-primary/20 font-mono text-xs">STOCK</Badge>
          <div className="flex items-center gap-1">
            <ArrowDown className="h-3 w-3 text-muted-foreground" />
            <Badge className="bg-[rgba(248,113,113,0.08)] text-destructive border-destructive/30 font-mono text-xs">SCRAP</Badge>
          </div>
        </div>
      </div>
